      ...
      <header className="bg-white shadow-md p-4">
        <div className="flex justify-between items-center">
          ...
          <nav
            ...
            } md:block absolute md:relative top-16 right-0 md:top-0 bg-white md:bg-transparent w-48 md:w-auto shadow-md md:shadow-none p-4 md:p-0 z-10`}
          >
            <ul className="md:flex gap-4">
              <li>
                <button
                  ...
                  className={`${
                    page === "home" ? "text-red-500" : "text-gray-700"
                  } hover:text-red-500`}
                >
                  Home
                </button>
              ...
              <li>
                <button
                  ...
                  className={`${
                    page === "mess" ? "text-red-500" : "text-gray-700"
                  } hover:text-red-500`}
                >
                  Mess Timetable
                </button>
              ...
              <li>
                <button
                  ...
                  className={`${
                    page === "rooms" ? "text-red-500" : "text-gray-700"
                  } hover:text-red-500`}
                >
                  Room Directory
                </button>
              ...
              <li>
                <button
                  ...
                  className={`${
                    page === "facilities" ? "text-red-500" : "text-gray-700"
                  } hover:text-red-500`}
                >
                  Facilities
                </button>
              ...
              <li>
                <button
                  ...
                  className={`${
                    page === "faqs" ? "text-red-500" : "text-gray-700"
                  } hover:text-red-500`}
                >
                  FAQs
                </button>
              ...
              <li>
                <button
                  ...
                  className={`${
                    page === "about" ? "text-red-500" : "text-gray-700"
                  } hover:text-red-500`}
                >
                  About
                </button>
      ...
      <footer className="bg-gray-800 text-white p-4 mt-8">
        <div className="container mx-auto">
          ...
          <div className="mt-4 text-center">
            <p>
              &copy; {new Date().getFullYear()} Not YourSpace. All rights
              reserved.
            </p>
          </div>
        </div>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-3xl font-bold mb-4 text-center">
        Welcome to Not YourSpace
      </h2>
      <p className="text-center mb-6">
        A home away from home in Lohegaon, Pune
      </p>
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-8">
        <div className="md:w-1/2">
          <p className="mb-4">
            ...
            comfortable living spaces for students and young professionals. With
            modern amenities and a community-focused environment, we strive to
...
function MessTimetable() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="mb-6">
        Our in-house mess provides nutritious and delicious meals. Check out our
        weekly menu below:
      </p>
        ...
        {Object.keys(menuData).map((d) => (
          <button
            ...
            className={`px-3 py-1 rounded ${
              day === d ? "bg-red-500 text-white" : "bg-gray-200"
            }`}
          >
      ...
      <div className="mb-8">
        <h3 className="text-xl font-bold mb-2 bg-yellow-100 p-2 rounded">
          BREAKFAST
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-4 rounded shadow">
            ...
            {menuData[day].breakfast.pickle !== "-" && (
              <p>Pickle: {menuData[day].breakfast.pickle}</p>
            )}
          </div>
          <div className="bg-white p-4 rounded shadow">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded shadow">
            ...
            {menuData[day].lunch.dal !== "-" && (
              <p>Dal: {menuData[day].lunch.dal}</p>
            )}
      ...
      <div className="bg-green-100 p-3 text-center text-sm rounded">
        Note: Menu is subject to change as per the availability of seasonal
        vegetables.
      </div>
    </div>
  );
...
function RoomDirectory() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="mb-6">
        Our hostel has 3 floors with 28 rooms on each floor. Each room
        accommodates 3 residents.
      </p>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        <button
          ...
          className={`px-3 py-1 rounded ${
            floor === "first" ? "bg-red-500 text-white" : "bg-gray-200"
          }`}
        >
          First Floor (100-128)
        </button>
        <button
          ...
          className={`px-3 py-1 rounded ${
            floor === "second" ? "bg-red-500 text-white" : "bg-gray-200"
          }`}
        >
        ...
        <button
          ...
          className={`px-3 py-1 rounded ${
            floor === "third" ? "bg-red-500 text-white" : "bg-gray-200"
          }`}
        >
          Third Floor (301-328)
        </button>
...
function Facilities() {
  const facilities = [
    {
      ...
      desc: "Stay connected with our 100 Mbps fiber internet connection",
    },
    {
      name: "Furnished Rooms",
      desc: "Comfortable beds, study tables, wardrobes, and air conditioning",
    },
    {
      name: "Common Room",
      desc: "Spacious common area with TV and indoor games",
    },
    {
      name: "Laundry Service",
      desc: "In-house laundry service available at nominal charges",
    },
    { name: "Gym", desc: "Small but well-equipped gym with basic equipment" },
    {
      name: "Mess",
      desc: "Nutritious and tasty meals served three times a day",
    },
    { name: "Security", desc: "24/7 security with CCTV surveillance" },
    {
      name: "Housekeeping",
      desc: "Regular cleaning of rooms and common areas",
    },
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="mb-6">
        We provide a range of amenities to make your stay comfortable and
        convenient.
      </p>
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="md:w-2/3">
          <p className="mb-4">
            Established in 2018, Not YourSpace started with a simple mission: to
            create a living space that feels like home for students and young
            professionals in Pune. What began as a small facility has now grown
            into a vibrant community.
          </p>

          <p className="mb-4">
            Our Lohegaon property is strategically located near the airport and
            major IT hubs, making it an ideal choice for those who value
            convenience without compromising on comfort.
          </p>

          <p className="mb-4">
            At Not YourSpace, we believe in creating more than just a place to
            sleep. Our community events, shared spaces, and friendly staff
            create an environment where lifelong friendships are formed.
          </p>
          ...
          <div className="mt-6">
            ...
            <ul className="list-disc pl-5">
              <li>
                <strong>Community:</strong> Fostering connections and
                friendships
              </li>
              <li>
              ...
              <li>
                <strong>Convenience:</strong> Making daily life easier for our
                residents
              </li>
              <li>
                <strong>Care:</strong> Prioritizing the well-being of our
                community
              </li>
            </ul>
          </div>
